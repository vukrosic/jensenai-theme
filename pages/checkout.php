        ...
        <div class="max-w-[360px] mx-auto">
            <div class="bg-white shadow-lg rounded-lg mt-9">
                ...
                <header class="text-center px-5 pb-5">
                    ...
                    <!-- Card name -->
                    <h3 class="text-xl font-bold text-gray-900 mb-1">Enter amount</h3>
                    <div class="text-sm font-medium text-gray-500">$0.02 / idea</div>
                </header>
                <!-- Card body -->
                <div class="bg-gray-100 text-center px-5 py-6">
                    <form class="space-y-3">
                        <div class="text-sm"><strong class="font-semibold">USD</strong> amount</div>
                        <div class="flex shadow-sm rounded">
                            <div class="flex-grow">
                                <input name="usd_amount" class="text-sm text-gray-800 bg-white rounded-l leading-5 py-2 px-3 placeholder-gray-400 w-full border border-transparent focus:border-indigo-300 focus:ring-0" type="number" placeholder="USD" aria-label="Card Number" />
                            </div>
                            
                        </div>
                        <br>
                        <div class="text-sm mb-6"><strong class="font-semibold">Ideas</strong> amount</div>
                        <div class="flex shadow-sm rounded">
                            <div class="flex-grow">
                                <input name="ideas_amount" class="text-sm text-gray-800 bg-white rounded-l leading-5 py-2 px-3 placeholder-gray-400 w-full border border-transparent focus:border-indigo-300 focus:ring-0" type="number" placeholder="Idea" aria-label="Card Number" />
                            </div>
                        ...
                        <script src="https://www.paypal.com/sdk/js?client-id=AXhVhtc-g5g-qVdp_2JqNtBskoZAP4KsiJ1vuL01y2yat-ZzoVIeHdkVXpEgD8vfOkHSCHgHDQkuZH8l&currency=USD"></script>
