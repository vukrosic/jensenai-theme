<?php
/*
Template Name: Standup Story API Call
*/
?>
...
function generateStory($promptTopic)
{
    ...
    $promptData = '{
        "prompt": "Write a funny story on the topic '.$promptTopic.' that I can use for a standup comedy set. The story should make the audience laugh.",
        "temperature": 0.75,
        "max_tokens": 50,
        "top_p": 1,
        "frequency_penalty": 0,
...
function insertIntoDatabase($promptTopic, $story)
{
    ...
    global $wpdb;
    $table = $wpdb->overldai_wp167 . 'stories';
    $tableData = array(
        'Idea' => $promptTopic,
        'Story' => $story
    );
